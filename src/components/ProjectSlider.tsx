          ...
          <div className="title-container flex flex-col gap-6 mb-24 rotate-3 justify-between items-center max-lg:w-[100vw]">
            ...
            >
              <p className="text-[--white] mt-16 mb-6">
                ...
                {language === "DE" ? "Projekte" : "Experience"}
                <span className="text-[--orange]">/&gt;</span>
              </p>
              <h2 className="text-[--white] mb-16">
                {language === "DE" ? "Meine Projekte" : "My Experience"}
              </h2>
            </motion.div>
            <Swiper
              effect={"cards"}
              ...
              {projectsData.map((project, index: number) => (
                ...
                >
                  <div className=" w-[55%] flex flex-col gap-12 justify-between ">
                    ...
                    <h4>
                      {project.subtitle}{" "}
                      <span className="text-[16px]">{`(${project.during})`}</span>
                    </h4>

                    <p className="text-white">
                      <ul>
                        {project.description_EN.map((desc, index) => (
                  ...
                  <div className="right-content relative h-[50rem] overflow-hidden rounded-xl w-[40%] transition-all duration-200 shadow-2xl">
                    <img
                      src={project.image}
